  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        injectFAQJSONLD(data.markdownContent);
      ...
      <main className="pb-20">
        <div className="max-w-7xl mx-auto px-5 md:px-8 pt-8">
          ...
          <nav className="flex items-center gap-1.5 text-sm mb-6" style={{ color: 'var(--text-muted)' }}>
            ...
            <span>/</span>
            <span className="truncate max-w-[140px] sm:max-w-[200px]">{article.title}</span>
          </nav>
          ...
          >
            ...
            <div className="flex items-center gap-2 flex-wrap mb-4">
              {isBreaking(article.createdAt) && (
                <span className="px-2.5 py-1 rounded text-xs font-bold text-white animate-pulse"
            ...
            {/* Title */}
            <h1
              className="text-[28px] md:text-5xl font-bold leading-tight mb-5"
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-2">
                  <a
                    ...
                    className="p-2.5 rounded-md border transition-colors hover:bg-[var(--bg-soft)]"
                  ...
                  <button
                    onClick={copyLink}
                    className="p-2.5 rounded-md border cursor-pointer transition-colors hover:bg-[var(--bg-soft)]"
                    style={{ borderColor: 'var(--border)' }}
                    title="Copy link"
                  >
                    {copied
