      ...
      <main className="max-w-4xl mx-auto px-8 pt-40 pb-60">
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-10 px-6 py-2.5 rounded-full border w-fit" style={{ background: 'var(--accent-soft)', borderColor: 'var(--accent-soft)' }}>
             ...
             <span className="text-[10px] font-black uppercase tracking-[0.3em]" style={{ color: 'var(--accent)' }}>Protocol & Privacy</span>
          </div>

          <h1 className="text-6xl md:text-8xl font-black mb-12 -tracking-tighter uppercase leading-[0.95] title">Privacy <br /><span className="gradient-text">Protocol</span></h1>
          <p className="text-[11px] font-black uppercase tracking-[0.4em] mb-20 border-b pb-12 w-fit subtitle" style={{ borderColor: 'var(--border)' }}>Effective Sequence: April 03, 2026</p>
